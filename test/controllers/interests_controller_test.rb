...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference("Interest.count") do
      post interests_url, params: { interest: { experience: @interest.experience, name: @interest.name, user_id: @interest.user_id } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { experience: @interest.experience, name: @interest.name, user_id: @interest.user_id } }
